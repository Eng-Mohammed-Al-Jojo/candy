      ...
      <main className="flex flex-col flex-1">
        ...
        <section className="relative flex flex-col items-center justify-center text-center py-10 px-6 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute w-[300] h-[400px] bg-(--primary) rounded-full blur-2xl"
          />
          ...
          >
            ...
            <motion.div
              ...
              style={{ willChange: "transform, opacity" }}
              className="absolute w-[150px] h-[220px] md:w-[250px] md:h-[320px] rounded-full border-4 border-primary/10"
            />
            ...
            <motion.img
              ...
              style={{ willChange: "transform, opacity" }}
              src="/logo.png"
              className="w-50 h-50 md:w-64 md:h-64 object-contain drop-shadow-[0_20px_40px_rgba(0,0,0,0.15)]"
              alt="Logo"
            />
